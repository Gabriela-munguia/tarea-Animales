...
public class ListadeReptiles 
{
    ...
    public void listaReptiles()
    {
        ...
        Console.Clear();
        Console.WriteLine("");
        Console.WriteLine("Listado de Reptiles ");
        Console.WriteLine("********************");
        ...
        {
            Console.WriteLine("Es un "+ reptiles.Especie + " Su nombre es " + reptiles.Nombre + " Tiene " + reptiles.Edad + " años " + " es " + reptiles.Genero + " tenemos  " + reptiles.Cantidad + " de esta especie " + " Se distingue por que si pelaje que es " + reptiles.Piel);
            Console.WriteLine("");
            Console.WriteLine("*********************************************************************************************************************************************");
            Console.WriteLine("");
        }
