...
public class Listadeanimales
{
    ...
    public void listarMamifero() 
    {
        Console.Clear();
        Console.WriteLine("");
        Console.WriteLine("Listado de Mamiferos ");
        Console.WriteLine("********************");
        ...
        {
            Console.WriteLine("Es un "+ mamiferos.Especie + " Su nombre es " + mamiferos.Nombre + " Tiene " + mamiferos.Edad + " años " + " es " + mamiferos.Genero + " tenemos  " + mamiferos.Cantidad + " de esta especie " + " Se distingue por que si pelaje que es " + mamiferos.Pelaje);
            Console.WriteLine("");
            Console.WriteLine("*********************************************************************************************************************************************");
            Console.WriteLine("");       
        }
