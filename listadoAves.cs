...
public class ListadeAves
{
    ...
    public void ListadAves()
    {
        ...
        Console.Clear();
        Console.WriteLine("");
        Console.WriteLine("Listado de Aves ");
        Console.WriteLine("********************");
        ...
        {
            Console.WriteLine("Es un "+ aves.Especie + " Su nombre es " + aves.Nombre + " Tiene " + aves.Edad + " años " + " es " + aves.Genero + " tenemos  " + aves.Cantidad + " de esta especie " + " Se distingue por que si pelaje que es " + aves.Plumaje);
            Console.WriteLine("");
            Console.WriteLine("*********************************************************************************************************************************************");
            Console.WriteLine("");
        }
